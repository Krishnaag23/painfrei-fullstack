...
const NewsLatterBox = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}contacts/`, formData);
  ...
  return (
    <div className="relative z-10 rounded-sm bg-high bg-opacity-30 p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#06413C" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
